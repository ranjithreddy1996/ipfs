...
@Component({
  selector: 'app-manu-damaged-in-form',
  templateUrl: './manu-damaged-in-form.component.html',
  styleUrls: ['./manu-damaged-in-form.component.css']
})
export class ManuDamagedInFormComponent implements OnInit {
  matidg: any;
  data: any;
...
console.log(getData);
  ...
  this.hash = filesAdded[0].hash;
    console.log(this.hash );
      ...
      this.web3.manufacture_at_damage(getData,"empty",ServiceData.productid,ServiceData.damage,ServiceData.quantity,this.hash,1 ).then(receipt=>{

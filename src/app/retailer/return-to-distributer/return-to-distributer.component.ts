...
@Component({
  selector: 'app-return-to-distributer',
  templateUrl: './return-to-distributer.component.html',
  styleUrls: ['./return-to-distributer.component.css']
})
export class ReturnToDistributerComponent implements OnInit {

  matidg: any;
  data: any;

  constructor(@Inject(IPFS) private ipfs,private modalService : NgbModal, private web3: Web3Service) { }
  return : Array<any>=[]
...
console.log(getData);
  ...
  this.hash = filesAdded[0].hash;
    console.log(this.hash );
      ...
      this.web3.manufacture_at_damage(getData,ServiceData.distributerid,ServiceData.productid,ServiceData.damage,ServiceData.quantity,this.hash,3 ).then(receipt=>{
